...
| --------- | ------------------------------------------------------------ | ------- | -------------------- | ------------------------------------------------------------ |
| K         | Environment capacity(different from the logistic model)      | 0.05    | OD <br/> (1 OD = 10<sup>8</sup> CFU) | we assume that the maximum bacteria number can reach 1 OD in a single 1 cm^2^ square |
